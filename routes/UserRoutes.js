...
router.get('/:id', (req, res)=>{
    res.status(200).json(
        {
            "message": `aquí va a mostrarse el user cuyo id es ${req.params.id}`
        }
    )
})
...
router.put('/:id', (req, res)=>{
    res.status(200).json(
        {
            "message": `aquí va a actualizar el user ${req.params.id}`
        }
    )
})
...
router.delete('/:id', (req, res)=>{
    res.status(200).json(
        {
            "message": `aquí se va a borrar el user ${req.params.id}`
        }
    )
})
